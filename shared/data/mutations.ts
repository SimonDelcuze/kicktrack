...
// Real Kick a Lucky Block mutations — Simon's data 2026-05-03.
// Order is by ascending multiplier (= weakest → strongest).
export const mutations: readonly Mutation[] = [
  ...
  { id: 9,  name: 'electrified',  multiplier: 16,  color_hex: '#7dd3fc', tier_order: 9  }, // bleu clair
  { id: 10, name: 'rainbow',      multiplier: 30,  color_hex: '#ec4899', tier_order: 10 }, // arc-en-ciel — color_hex is fallback; UI applies a gradient.
] as const;
